	...
	public MenuExam() {
		...
		miNewFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(MenuExam.this, "새파일 메뉴를 눌러부렀당께~");
			}
		});
		...
		JMenuItem miEnxit = new JMenuItem("종료");
		miEnxit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int result = JOptionPane.showConfirmDialog(MenuExam.this, "진심으로 종료할까요?");
