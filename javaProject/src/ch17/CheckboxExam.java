...
public class CheckboxExam extends JFrame {
	...
	public CheckboxExam() {
		...
		ckJava.addItemListener(new ItemListener() {
			//체크박스에 체크, 언체크 ==>itemStateChanged 자동 호출
			public void itemStateChanged(ItemEvent e) {
				System.out.println(e.getStateChange());//getStateChange()체크박스의 체크상태를 가져오는 메소드
				if(e.getStateChange()==ItemEvent.SELECTED) {//체크
					ta.append("Java를 신청했습니다.\n");
				}else {//언체크 (자동 DESELECTED처리
